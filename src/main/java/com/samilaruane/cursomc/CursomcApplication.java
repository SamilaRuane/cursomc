...
import com.samilaruane.cursomc.domain.Endereco;
import com.samilaruane.cursomc.domain.Estado;
import com.samilaruane.cursomc.domain.ItemPedido;
import com.samilaruane.cursomc.domain.Pagamento;
import com.samilaruane.cursomc.domain.PagamentoComBoleto;
import com.samilaruane.cursomc.domain.PagamentoComCartao;
...
import com.samilaruane.cursomc.domain.enums.TipoCliente;
...
import com.samilaruane.cursomc.repositories.EnderecoRepository;
import com.samilaruane.cursomc.repositories.EstadoRepository;
import com.samilaruane.cursomc.repositories.ItemPedidoRepository;
import com.samilaruane.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Cliente cli1 = new Cliente (null, "Maria Silva", "maria@gmail.com", "94374983", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("999999999", "787384738"));
		
		Endereco end1 = new Endereco (null, "Rua Flores", "300", "Apto 303", "Jardim", "38373878", cli1, c1);
		Endereco end2 = new Endereco (null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c3);
